...
router.post('/likeMovie', function (req, res, next) {
    stu.MyStudent.update({"email": req.userInfo.email}, {
        $addToSet: {
            like: {
...
router.post('/comment', function (req, res, next) {
    ...
    stu.MyMovie.update({"name": req.body.name}, {
        $addToSet: {
            comment: {
                name: userName,
                line: req.body.line
...
var sessionKey = '06ba9423ff2dfca7239308b61085475d';
...
//获取微信小程序运动步数
router.post('/getstepall', function (req, res, next) {
